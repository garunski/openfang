//! Channels screen: Signal + Mattermost setup, test, and toggle.
...
// ── Channel definitions (must match API `CHANNEL_REGISTRY` + `/api/channels/{name}/*`) ──
...
const CHANNEL_DEFS: &[ChannelDef] = &[
    ChannelDef {
        ...
        category: "Messaging",
        env_vars: &[],
        description: "Signal via signal-cli REST API — set api_url and phone_number in config.toml",
    },
    ChannelDef {
        name: "mattermost",
        ...
        description: "Mattermost WebSocket adapter (bot token + server URL in config.toml)",
    },
];

const CATEGORIES: &[&str] = &["All", "Messaging", "Enterprise"];
